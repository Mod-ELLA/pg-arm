...
{
  emlrtMsgIdentifier thisId;
  static const char * fieldNames[3] = { "u", "r", "x" };

  thisId.fParent = parentId;
  emlrtCheckStructR2012b(sp, parentId, u, 3, fieldNames, 0U, 0);
  thisId.fIdentifier = "u";
  h_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2013a(sp, u, 0, "u")), &thisId,
                     y->u);
  thisId.fIdentifier = "r";
  h_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2013a(sp, u, 0, "r")), &thisId,
                     y->r);
  thisId.fIdentifier = "x";
  i_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2013a(sp, u, 0, "x")), &thisId,
                     y->x);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *msgId, real_T ret[10])
{
  ...
  for (i4 = 0; i4 < 10; i4++) {
    ret[i4] = (*(real_T (*)[10])mxGetData(src))[i4];
  }
  ...
  emlrtMsgIdentifier *msgId, real_T ret[20])
{
  ...
  for (i5 = 0; i5 < 10; i5++) {
    for (i6 = 0; i6 < 2; i6++) {
      ret[i6 + (i5 << 1)] = (*(real_T (*)[20])mxGetData(src))[i6 + (i5 << 1)];
    }
  }
